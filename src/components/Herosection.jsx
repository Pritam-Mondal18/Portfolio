    ...
    >
      ...
      <div className="flex items-center mt-8 md:mt-0">
        ...
        <div className="flex flex-col space-y-4">
          <a
            href="https://www.facebook.com/profile.php?id=100025051042382"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Facebook"
            className="text-gray-300 hover:text-green-500 transition hover:scale-110"
          >
            <FaFacebook size={24} />
          </a>
          <a
            href="https://www.instagram.com/liton198/"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://www.linkedin.com/in/pritam-mondal-7590ab284/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
            className="text-gray-300 hover:text-green-500 transition hover:scale-110"
          ...
          <a
            href="https://github.com/Pritam-Mondal18"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="GitHub"
            className="text-gray-300 hover:text-green-500 transition hover:scale-110"
