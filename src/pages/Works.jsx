    ...
    () => [
      {
        ...
        longDescription:
          "Comic Crafter AI lets users create custom comic strips using AI, leveraging OpenAI GPT-3.5 Turbo for story generation and DALL·E for image creation.",
      ...
      },
      {
        category: "Frontend",
        title: "portfolio",
        description: "To showcase my work",
        longDescription:
          "A portfolio website to showcase my work and projects. It is built using React, Tailwind CSS, and Framer Motion.",
        image: portfolio,
