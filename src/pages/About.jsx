...
const AboutSection = () => {
  return (
    <div
      id="about"
      className="about-area relative bg-white w-full min-h-screen z-10"
      style={{
            ...
            <div className="about-content relative">
              ...
              <div className="mb-6">
                ...
                <h2 className="text-3xl font-bold text-gray-900 mt-2">
                  Hi, I am Pritam Mondal
                </h2>
              </div>

              {/* Description */}
              <p className="text-gray-600 mb-4 w-4/3">
                I am a passionate Web Developer with expertise in React,
                Tailwind CSS, and modern UI/UX design. I specialize in creating
                responsive, user-friendly, and high-performance applications.
                <br />
                <br />
                With a strong foundation in Artificial Intelligence & Machine
                Learning, I blend technology with creativity to build seamless
                digital experiences. Constantly learning and experimenting, I
                aim to develop innovative solutions that make an impact.
                <br />
                <br />
                🔹 <b>Skills:</b> React.js, Node.js, Tailwind CSS, JavaScript,
                Python
                <br />
                🔹 <b>Interests:</b> AI,Web Performance Optimization
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 w-4/3">
                <div className="flex items-center">
                  ...
                  <span>Pritam Mondal</span>
                </div>
                <div className="flex items-center">
                  <span className="font-semibold w-32">Phone:</span>
                  <span>+91 7439885351</span>
                </div>
                <div className="flex items-center">
                ...
                <div className="flex items-center">
                  ...
                  <span>pritammondal18012003@gmail.com</span>
                </div>
                <div className="flex items-center">
