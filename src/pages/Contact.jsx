          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">+91 7439885351</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  pritammondal18012003@gmail.com
                </p>
              </div>
            </motion.div>
          </div>
          ...
          >
            <form ref={form} onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className={`w-full bg-[#4ADE80] text-white text-sm py-2.5 rounded-lg font-medium hover:bg-[#3dbb6d] transition-colors ${
